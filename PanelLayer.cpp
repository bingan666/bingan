...
bool PanelLayer::init()
{
	...
	_goldCounter->setPosition(ccp(500, 15));

	ScheduleCountDown* countDown = ScheduleCountDown::create(this);

	_scheduleLabel = CCLabelTTF::create("30", "Thonburi", 60);
	_scheduleLabel->setColor(ccc3(255, 235, 205));
	_scheduleLabel->addChild(countDown);
	this->addChild(_scheduleLabel);
	_scheduleLabel->setPosition(ccp(400, 15));
