...
bool GameMenuLayer::init()
{
	do 
	{
		...
		titleSprite->setPosition(ccp(winSize.width/2, winSize.height * 0.65));
...
void GameMenuLayer::createMenu(void)
{
	...
	startNormalTextSprite->setPosition(ccp(startNormalBgSize.width / 2, startNormalBgSize.height / 2 + 10));
	...
	startSelectedTextSprite->setPosition(ccp(startNormalBgSize.width / 2, startNormalBgSize.height / 2 + 10));
